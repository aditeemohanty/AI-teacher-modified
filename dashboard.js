...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('mathGestureBtn').addEventListener('click', function() {
        fetch('/start-math-gesture')
            .then(response => {
                if (response.ok) {
...
// Remove or comment out the old openMathGesture function if it exists 